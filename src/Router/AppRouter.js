...
import VettingDashboardSupport from '../Components/VettingApp/Dashboard/DashboardSupport';
    ...
    <HashRouter>
      <ThemeProvider theme={theme}>
        <Switch>
          ...
          <Route path="/vetting-app/dashboard-developer" component={VettingDashboardSupport} />

      ...
      <Grid container justify="center" className="mb-4">
        <Grid item xs={8}>
          <Typography>
            ...
            users vetting requests for accessing to confidential microdata.
            These vetting requests are subject to a risk-based assessment of
            potential disclosure based on established rules and procedures. For
          ...
          <div className={classes.guidelinesBox}>
            ...
            <Typography variant="subtitle2">
              A completed request form will be stored as part of the request
              record.
            </Typography>
          </div>
          <FormControl
